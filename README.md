...
- **Adaptive Program Display**: Grid layout on desktop, stacked cards on mobile
...
- **Programs**: Three featured programs with Facebook page integrations
  - Youth Cup 2025
  - Kushtia Youth Climate Summit
  - Climate Olympiad 2025
...
├── 5.png               # Youth Cup 2025 program image
├── 7.png               # Kushtia Summit program image
├── 8.png               # Climate Olympiad program image
├── 9.png               # Hero slider image 1
├── 10.png              # Hero slider image 2
├── 11.png              # Hero slider image 3
